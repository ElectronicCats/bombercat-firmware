            ...
            <section class="ssid">
                <div class="form-container">
                    ...
                    <form action="#" class="form" method="POST">
                        <input type="text" required id="tvSSID" placeholder="Name" class="input" name="ssid">
                        <input type="text" required id="tvPassword" placeholder="Password" class="input" name="pass">
