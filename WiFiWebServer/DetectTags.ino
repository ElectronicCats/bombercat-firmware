 ...
 * March 2020
 *
 * Updated by Francisco Torres, Raul Vargas - Electronic Cats -
 * electroniccats.com
 *
 * Jul 2025
 *
...
void displayCardInfo() { // Funtion in charge to show the card/s in te field
  ...
  while (true) {
    ...
    case nfc.protocol.ISODEP:
      pollMode = "POLL MODE: Remote activated tag type: " +
                 String(nfc.remoteDevice.getProtocol());
    ...
    case (nfc.tech.PASSIVE_NFCA):
      ...
      memcpy(&uidcf[10], nfc.remoteDevice.getNFCID(),
             nfc.remoteDevice.getNFCIDLen());
